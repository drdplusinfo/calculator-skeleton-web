...
abstract class AbstractContentTest extends TestWithMockery
{
    ...
    {
        return $this->getCalculatorWebContent()->getHtmlDocument();
    }

    protected function getCalculatorWebContent(): CalculatorWebContent
    {
        ...
        return new CalculatorWebContent($htmlHelper, $head, $body);
    }
